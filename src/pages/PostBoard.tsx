    ...
    >
      {!searchOn && (
        <>
          {/* 상단 바 */}
          <BoardNavigationBar>
            <PageNameWrapper>게시판</PageNameWrapper>
            <IconWrapper>
              <img
                src={searchIcon}
                alt="searchIcon"
          ...
          <CategoryContainer>
            <CategoryWrapper
              style={{
                color:
                  selectedCategory === "전체" ? `${colors.primary100}` : "",
            ...
            <CategoryWrapper
              style={{
                color:
                  selectedCategory === "개인레슨" ? `${colors.primary100}` : "",
                fontWeight: selectedCategory === "개인레슨" ? "600" : "",
                borderBottom:
                  selectedCategory === "개인레슨"
                    ? `1px solid ${colors.primary100}`
                    : "",
              }}
            ...
            <CategoryWrapper
              style={{
                color:
                  selectedCategory === "악기장터" ? `${colors.primary100}` : "",
                fontWeight: selectedCategory === "악기장터" ? "600" : "",
                borderBottom:
                  selectedCategory === "악기장터"
                    ? `1px solid ${colors.primary100}`
                    : "",
              }}
