    ...
    <PageContainer style={{ padding: "0", width: "100%" }}>
      {!searchOn && !fileterOn && (
        <>
          {/* 상단 바 */}
          <MainNavigationBar>
            <PageNameWrapper>멤버리스트</PageNameWrapper>
            <IconWrapper>
              <img
                src={searchIcon}
                alt="searchIcon"
          ...
          <CategoryContainer>
            <CategoryWrapper
              style={{
                color:
                  selectedCategory === "추천" ? `${colors.primary100}` : "",
      ...
      {fileterOn && <FilterContainer backOnClick={() => setFilterOn(false)} />}
    </PageContainer>
  );
}
